<%@ page language="java" contentType="text/html; charset=UTF-8"
   pageEncoding="UTF-8"%>
<%@ page
   import="java.util.*, java.net.URLDecoder, org.big.dto.*, org.big.dao.*"%>
      ...
      <div class="row align-items-md-stretch alert alert-info">
         ...
         <div class="row justify-content-between">
            <div class="col-4" align="left">
               ...
               <% out.println(shipping_name); %><br> 우편번호 :
               <% out.println(shipping_zipCode); %><br> 주소 :
               <% out.println(shipping_addressName); %>(<% out.println(shipping_country); %>)
            </div>
