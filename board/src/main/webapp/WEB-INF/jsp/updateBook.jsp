...
<body>
   <div class="container py-4">
      ...
      <div class="row align-items-md-stretch">
         <div class="col-md-5">
            <img alt="image.jpg"
               src="/images/<%=rs.getString("b_filename")%>"
               style="width: 100%" />
         </div>
         <div class="col-md-7">
            <form name="newBook" action="/bookmarket/processUpdateBook.do" method="post"
               ...
               <div class="mb-3 row">
                  ...
                  <div class="col-sm-5">
                     <input id="unitsInStock" type="text" name="unitsInStock"
               ...
               <div class="mb-3 row">
                  ...
                  <div class="col-sm-8">
                     <%
                        String condition = rs.getString("b_condition");   //기존 저장된 상태 값
                     %>
                     <input type="radio" name="condition" value="New" <%= "New".equals(condition) ? "checked" : "" %>>신규도서 <input
                        type="radio" name="condition" value="Old" <%= "Old".equals(condition) ? "checked" : "" %>>중고도서 <input
                        type="radio" name="condition" value="EBook" <%= "EBook".equals(condition) ? "checked" : "" %>>E-Book
                  </div>
               </div>
